        ...
        <div>
            ...
            <div className="flex gap-4 my-8">
                <div className="bg-primary/3 border border-primary/10 rounded flex p-4 pr-8">
                    <img src={assets.totalBookingIcon} className="max-sm:hidden h-10" alt="total booking icon" />
                ...
                <div className="bg-primary/3 border border-primary/10 rounded flex p-4 pr-8">
                    <img src={assets.totalRevenueIcon} className="max-sm:hidden h-10" alt="total revenue icon" />
                    <div className="flex flex-col sm:ml-4 font-medium">
